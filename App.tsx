...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    photoSizeError: "Photo must be less than 10MB.",
    unsupportedPhotoType: "Unsupported file type. Please upload a JPEG, PNG, or WEBP image.",
    ...
    predictedTrafficCongestion: "Predicted Traffic Congestion",
    waterShortageRisk: "Water Shortage Risk",
    // Login Page
  ...
  hi: {
    ...
    photoSizeError: "फोटो 10MB से कम होनी चाहिए।",
    unsupportedPhotoType: "असमर्थित फ़ाइल प्रकार। कृपया एक JPEG, PNG, या WEBP छवि अपलोड करें।",
    ...
    aboutMissionContent: "हमारा मिशन प्रत्येक नागरिक को सार्वजनिक सेवाओं के बारे में अपनी चिताओं को आसानी से और प्रभावी ढंग से व्यक्त करने के लिए सशक्त बनाना है। हम प्रौद्योगिकी का लाभ उठाकर पारदर्शिता, जवाबदेही और सहयोग को बढ़ावा देते हैं, जिससे नागरिक मुद्दों का तेजी से और अधिक कुशल समाधान होता है और बेहतर, अधिक उत्तरदायी शहरों का निर्माण होता है।",
    ...
    predictedTrafficCongestion: "अनुमानित ट्रैफिक जाम",
    waterShortageRisk: "पानी की कमी का खतरा",
    // Login Page - Hindi
